...
"[project]/src/components/dashboard/UserWorksDisplay.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UserWorksDisplay({ initialWorks, currentUser }) {
    ...
    const availableYearsForUserWorks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!initialWorks || initialWorks.length === 0) return [];
        const years = new Set(initialWorks.map((work)=>work.eventYear).filter((year)=>year != null));
        return Array.from(years).sort((a, b)=>b - a);
    }, [
...
//# sourceMappingURL=src_components_1ba1848c._.js.map