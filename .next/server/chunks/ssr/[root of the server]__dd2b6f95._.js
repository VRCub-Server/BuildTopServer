...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ {"00444a9b508884d641eff34582900ccddb872a70cb":"getRawBuildings","006769990f4d29db3d9642a057b6c38a9af6f7f32c":"getUserSession","00924a3e4b3549f137af9ec57358120be960cd01d8":"handleLogout","00b53290c574162d521b2261cba165a710273a3676":"getCompetitions","00ce9bdb447cffe92dcd2aee716fbfa0e477608bc5":"getActiveWorks","00ffd345da1ee8ed3ad262d7d91de5b18b0eb1399a":"getHistoricalWorksGroupedByCompetition","403eadd05e4274e25f43462da6774833b55e6f2f87":"handleLoginRedirect","407f93716e27995cc8830e1f1d5ff2e0c2a84dc3e8":"submitVote","40879a9ed5d6d88b171cdf9253f357fb32f3c77043":"createCompetition","40b24ab5dbccb480c13336f04053d80a7723aff5a8":"getBuildingById","40bd91dfe39c11ef19064625013e11e94fb027dc2a":"deleteCompetition","60513ea9dda8cd1745a1150d9bcbeec7155772ee8e":"updateBuildingStatus","607acda03dac0d4d7cf38b97d5478bafacce1db8af":"updateCompetition","607bba3b7039b3a43163cd4a517fcb4b906303a084":"processLoginCallback","60d2d822a8bd46c12f18db482c6be3a8a324a09f47":"handleStaffLogin"} */ __turbopack_context__.s({
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ handleStaffLogin(prevState, formData) {
    ...
    if (username === 'admin' && password === '123456') {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('/'); // 登录成功后重定向到首页
    // redirect() 会抛出错误，因此此处无需显式 return
    } else {
        return {
            error: '无效的员工帐户或密码。'
        };
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getBuildingById(id) {
    const building = serverBuildings.find((b)=>b.id === id);
    return building ? JSON.parse(JSON.stringify(building)) : undefined;
}
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getActiveWorks() {
    const competitions = await getCompetitions();
    const activeCompetitionIds = competitions.filter((comp)=>comp.status === '进行中').map((comp)=>comp.id);
    const activeWorks = serverBuildings.filter((building)=>building.competitionId && activeCompetitionIds.includes(building.competitionId) && building.status === '有效' // Only active and valid works on homepage
    ).sort((a, b)=>b.votes - a.votes);
    return JSON.parse(JSON.stringify(activeWorks));
}
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getHistoricalWorksGroupedByCompetition() {
    const allCompetitions = await getCompetitions(); // This already returns a deep copy from serverCompetitions
    const allBuildings = await getRawBuildings(); // This already returns a deep copy from serverBuildings
    const historicalCompetitionsData = allCompetitions.filter((comp)=>comp.status !== '进行中').sort((a, b)=>{
        // Sort by year descending
        if (b.year !== a.year) {
            return b.year - a.year;
        }
        // Then by start date descending (more recent start date first)
        const dateA = new Date(a.startDate).getTime();
        const dateB = new Date(b.startDate).getTime();
        if (dateB !== dateA) {
            return dateB - dateA;
        }
        // Finally by name ascending for tie-breaking
        return a.name.localeCompare(b.name);
    });
    const groupedWorks = historicalCompetitionsData.map((comp)=>{
        const worksForCompetition = allBuildings.filter((building)=>building.competitionId === comp.id) // No filter on building.status here
        .sort((wa, wb)=>wb.votes - wa.votes); // Sort works within a competition by votes
        return {
            ...comp,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getBuildingById, "40b24ab5dbccb480c13336f04053d80a7723aff5a8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getActiveWorks, "00ce9bdb447cffe92dcd2aee716fbfa0e477608bc5", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getHistoricalWorksGroupedByCompetition, "00ffd345da1ee8ed3ad262d7d91de5b18b0eb1399a", null);
...
"[project]/src/components/auth/LogoutButton.tsx (client reference/proxy) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/auth/LogoutButton.tsx (client reference/proxy)": ((__turbopack_context__) => {
"use strict";
...
var { g: global, __dirname } = __turbopack_context__;
{
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$auth$2f$LogoutButton$2e$tsx__$28$client__reference$2f$proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/auth/LogoutButton.tsx (client reference/proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$auth$2f$LogoutButton$2e$tsx__$28$client__reference$2f$proxy$29$__ = __turbopack_context__.i("[project]/src/components/auth/LogoutButton.tsx (client reference/proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$auth$2f$LogoutButton$2e$tsx__$28$client__reference$2f$proxy$29$__);
}}),
"[project]/src/components/layout/UserNavOrLogin.tsx [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function UserNavOrLogin() {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUserSession"])();
    if (user) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$UserNavOrLogin$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/layout/UserNavOrLogin.tsx [app-rsc] (ecmascript)");
;
;
;
;
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$UserNavOrLogin$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                            fileName: "[project]/src/components/layout/Header.tsx",
                            lineNumber: 19,
                            columnNumber: 11
                        }, this)
...
const metadata = {
    title: '像素建筑馆',
    description: '展示精选的Minecraft建筑作品，并为它们投票。'
};
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dd2b6f95._.js.map