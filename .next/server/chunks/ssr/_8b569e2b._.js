    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchSession() {
            ...
            try {
                ...
                if (!sessionUser) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["redirect"])(`/login?message=请登录以访问仪表盘&redirect=${pathname}`);
                } else {
                    setUser(sessionUser);
                }
            } catch (error) {
                console.error("Error fetching user session in dashboard layout:", error);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["redirect"])(`/login?message=会话加载失败，请重新登录&redirect=${pathname}`);
            } finally{
                setLoading(false);
            }
        }
...
//# sourceMappingURL=_8b569e2b._.js.map