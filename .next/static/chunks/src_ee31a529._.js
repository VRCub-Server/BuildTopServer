(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_ee31a529._.js", {
...
// For non-staff users, these are their primary "User Center" links
...
function UnifiedSidebar() {
    ...
    if (!loadingSession && currentUser) {
        if (currentUser.type === 'staff') {
            ...
            // Regular logged-in user: show all primary dashboard navigation items
            finalNavItems.push(...dashboardNavItems);
        }
    }
    // No "else" needed for non-logged-in users, as publicNavItems are already the base.
    // Remove duplicates (just in case, though the logic above should prevent it)
    finalNavItems = finalNavItems.filter((item, index, self)=>index === self.findIndex((t)=>t.href === item.href && t.label === item.label));
    // This check is handled by RootLayout now, UnifiedSidebar is not rendered on admin paths.
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarContent"], {
                children: loadingSession ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    ...
                    // For /admin, it should be active if pathname starts with /admin.
                    // For /dashboard, it should be active if pathname starts with /dashboard.
                    // For exact paths like '/', it should only be active if pathname is exactly that.
                    let isActive = false;
                    if (item.href === '/') {
                        isActive = pathname === '/';
                        ...
                        isActive = pathname.startsWith('/dashboard') && item.href === '/dashboard'; // Main dashboard link
                    } else {
                        isActive = pathname.startsWith(item.href);
                    }
                    // Special handling for dashboard sub-items to be active only on their exact path
...
//# sourceMappingURL=src_ee31a529._.js.map