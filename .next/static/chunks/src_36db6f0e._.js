(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_36db6f0e._.js", {
...
function DashboardLayout({ children }) {
    ...
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])(); // For redirect logic if needed
            ...
            async function fetchSession() {
                ...
                try {
                    ...
                    if (!sessionUser) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])(`/login?message=请先登录以访问仪表盘&returnTo=${encodeURIComponent(pathname)}`);
                    } else {
                        setUser(sessionUser);
                    }
                } catch (error) {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])(`/login?message=会话加载失败，请重新登录&returnTo=${encodeURIComponent(pathname)}`);
                } finally{
                    setLoading(false);
                }
            }
...
_s(DashboardLayout, "jUGVNMZ2gc/0exvYVMnaaviWwu0=", false, function() {
    return [
...
//# sourceMappingURL=src_36db6f0e._.js.map