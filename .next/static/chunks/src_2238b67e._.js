(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2238b67e._.js", {
...
function UnifiedSidebar() {
    ...
    if (loadingSession) {
    // Skeleton items will be handled below inside the map
    } else if (currentUser) {
        // All logged-in users get dashboard items
        finalNavItems.push(...dashboardNavItems);
        // Staff users additionally get the admin area link
        if (currentUser.type === 'staff') {
            finalNavItems.push(adminAreaLink);
        }
    }
    // Remove duplicates - useful if dashboard and public items might overlap conceptually in future
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarContent"], {
                children: loadingSession ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    ...
                    if (item.href === '/') {
                        ...
                        // Special handling for main /admin link to be active for all admin sub-views if needed.
                        // However, admin page has its own internal sidebar now.
                        // This UnifiedSidebar's /admin link is just an entry point.
                        isActive = pathname.startsWith('/admin');
                    } else if (item.href === '/dashboard' && pathname.startsWith('/dashboard')) {
                        // Main dashboard link is active if any dashboard sub-page is active,
                        // OR if it's the exact dashboard page.
                        isActive = pathname === '/dashboard' || item.href === '/dashboard' && pathname.startsWith('/dashboard/');
                    } else {
                        // For specific sub-pages like /dashboard/submit or /history
                        isActive = pathname === item.href;
                    }
                    // Ensure correct active state for dashboard sub-items when on that exact path
...
//# sourceMappingURL=src_2238b67e._.js.map