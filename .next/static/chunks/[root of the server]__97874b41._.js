(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__97874b41._.js", {
...
function UnifiedSidebar() {
    ...
    if (isAdminPath) {
        return null; // Admin has its own sidebar in its own layout
    }
    let navItemsToShow = [];
    if (isDashboardPath) {
        // User is in the dashboard area
        navItemsToShow = [
            ...publicNavItems,
            ...dashboardNavItems.filter((item)=>!item.staffOnly)
        ];
        if (currentUser?.type === 'staff') {
            // If staff is somehow in dashboard, still show admin link
            navItemsToShow.push(adminAreaLink);
        }
    } else {
        // User is in a public area (not dashboard, not admin)
        navItemsToShow = [
            ...publicNavItems
        ];
        if (currentUser) {
            ...
            // Add a link to the dashboard for logged-in non-staff users
            const mainDashboardLink = dashboardNavItems.find((item)=>item.href === '/dashboard');
            if (mainDashboardLink && currentUser.type !== 'staff') {
                navItemsToShow.push(mainDashboardLink);
            }
        }
    }
    // Filter items based on user type and path more broadly
    navItemsToShow = navItemsToShow.filter((item)=>{
        if (item.dashboardUserOnly && (!currentUser || currentUser.type === 'staff') && !isDashboardPath) return false;
        if (item.dashboardUserOnly && !isDashboardPath && currentUser && currentUser.type !== 'staff') return false; // Hide specific dashboard sub-links if not on dashboard path for regular user
        if (item.dashboardUserOnly && isDashboardPath && currentUser?.type === 'staff') return false; // Staff should not see user dashboard items when on dashboard path (they have admin panel)
        if (item.staffOnly && (!currentUser || currentUser.type !== 'staff')) return false;
        if (item.adminPathOnly && !isAdminPath) return false;
        return true;
    });
    // Remove duplicates
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarContent"], {
                children: loadingSession ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    ...
                    const isActive = item.href === '/' && pathname === '/' || item.href !== '/' && pathname.startsWith(item.href) || item.href === '/admin' && isAdminPath; // Ensure /admin highlights Admin link
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarInset"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex-1 overflow-y-auto", !isAdminPage && !isAuthPage && "p-4 sm:p-6 lg:p-8", isAuthPage && !isAdminPage && "p-4 sm:p-6 lg:p-8 flex" // Ensure auth pages can center content
                                            ),
                                            children: children
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/layout.tsx",
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__97874b41._.js.map