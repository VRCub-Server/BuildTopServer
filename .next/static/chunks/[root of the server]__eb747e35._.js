(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__eb747e35._.js", {
...
function UnifiedSidebar() {
    ...
    // This sidebar component will not be rendered on /admin paths due to RootLayout logic
    let navItemsToShow = [
        ...publicNavItems
    ];
    if (currentUser) {
        if (currentUser.type === 'staff') {
            // Staff see public links, dashboard links (if enabled for them or not on dashboard path), and Admin Panel link
            if (isDashboardPath) {
                navItemsToShow = [
                    ...navItemsToShow,
                    ...dashboardNavItems
                ...
                // Show main dashboard link if not on a dashboard path
            ...
            navItemsToShow.push(adminPanelLink);
        } else {
            if (isDashboardPath) {
                // On dashboard path, show all public and dashboard items
                navItemsToShow = [
                    ...publicNavItems,
                    ...dashboardNavItems
                ];
            } else {
                // Not on dashboard path, show public items and main dashboard link
                const mainDashboardLink = dashboardNavItems.find((item)=>item.href === '/dashboard');
                if (mainDashboardLink) navItemsToShow.push(mainDashboardLink);
            }
        }
    ...
    navItemsToShow = navItemsToShow.filter((item)=>{
        if (item.dashboardUserOnly && (!currentUser || currentUser.type === 'staff')) return false;
        if (item.staffOnly && (!currentUser || currentUser.type !== 'staff')) return false;
        return true;
    });
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarContent"], {
                children: loadingSession ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    ...
                    const isAdminViewActive = item.href.startsWith('/admin') && pathname === item.href; // For future if admin links were here
                    const isActive = item.href === '/' && pathname === '/' || item.href !== '/' && pathname.startsWith(item.href) && !item.href.startsWith('/admin') || isDashboardPath && item.href.startsWith('/dashboard') && pathname === item.href || isAdminViewActive;
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarInset"], {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex-1 flex flex-col bg-background overflow-x-hidden", isAdminPage && "md:ml-0 group-data-[sidebar-state=expanded]/sidebar-wrapper:md:ml-0" // Ensure admin page takes full width
                                    ),
                                    children: [
                                        !isAuthPage && !isAdminPage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex-1 overflow-y-auto", !isAuthPage && !isAdminPage && "p-4 sm:p-6 lg:p-8", isAuthPage && "", isAdminPage && "" // Admin page controls its own internal padding
                                            ),
                                            children: children
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/layout.tsx",
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__eb747e35._.js.map