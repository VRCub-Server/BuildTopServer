(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_ff30c58a._.js", {
        ...
        "DashboardLayout.useEffect": ()=>{
            async function fetchSession() {
                ...
                try {
                    ...
                    if (!sessionUser) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])(`/login?message=请登录以访问仪表盘&redirect=${pathname}`);
                    } else {
                        setUser(sessionUser);
                    }
                } catch (error) {
                    console.error("Error fetching user session in dashboard layout:", error);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])(`/login?message=会话加载失败，请重新登录&redirect=${pathname}`);
                } finally{
                    setLoading(false);
                }
            }
...
//# sourceMappingURL=_ff30c58a._.js.map